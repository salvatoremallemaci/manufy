    ...
    <>
      ...
      <div className="h-[10%] bg-black flex justify-between items-center text-white px-4 relative">
        <div className="hidden lg:flex items-center gap-4">
          <img className="w-12 rounded min-w[50px] h-[50px]" src={track.image} alt="" />
          <div>
            <p>{track.name}</p>
        ...
        <div className="flex flex-col items-center gap-1 m-auto">
          <div className="flex gap-4">
            <img onClick={handleButtonClick} className="w-4 cursor-pointer" src={assets.shuffle_icon} alt="" />
            ...
            <img onClick={handleButtonClick} className="w-4 cursor-pointer" src={assets.loop_icon} alt="" />
          </div>
